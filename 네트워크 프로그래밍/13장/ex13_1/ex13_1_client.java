...
// 239.255.10.10:5265
public class ex13_1_client implements Runnable, WindowListener, ActionListener {
	...
	public ex13_1_client(InetAddress group, int port) {
		this.group = group;
		this.port = port;
		initAWT();
	}
	...
	public void actionPerformed(ActionEvent ae) {
		try {
			...
			input.setText("");
			outgoing.setLength(outgoing.getData().length);
			String message = new String(outgoing.getData(), 0, outgoing.getLength(), "UTF8");
	...
	public static void main(String args[]) throws IOException {
		...
		ex13_1_client chat = new ex13_1_client(group, port);
		chat.start();
	}
}